...
(Does NOT apply to initial Project Bootstrap, THIS JUST ONLY FOR DO NEW UI FEATURE)

## P0 — Output Contract + Priority Gate (MANDATORY)

Any task assigned to the AI in this project is considered **DONE** only if the final output fully complies with the Output Contract and passes the Priority Gate.
...
- Always execute golden test from this skill at the end of task. 
- Detailed guideline : `.trae/skills/flutter/testing/SKILL.md`
