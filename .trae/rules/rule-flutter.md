...
-  All golden tests are generated.
...
- `.trae/skills/output-contract-priority-gate/SKILL.md`
...
4. **Testing**: Is `flutter_test` used for golden testing is done?
-> Did you generate golden tests for task?
